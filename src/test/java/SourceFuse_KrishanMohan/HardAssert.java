...
public class HardAssert {
	...
	@Test
	public void AssertForAllFields() {
		...
		String actualCurrentCompany = driver.findElement(By.xpath("//div[@id='curCompanyInput']/input"))
				.getAttribute("value");
		Assert.assertEquals(actualCurrentCompany, currentCompany);
		...
		String actualPositionYouAreApplyingFor = driver.findElement(By.xpath("//div[@id='positionInput']/input"))
				.getAttribute("value");
		Assert.assertEquals(actualPositionYouAreApplyingFor, positionYouAreApplyingFor);
		String actualPortfolioWebsite = driver.findElement(By.xpath("//div[@id='portfolioInput']/input"))
				.getAttribute("value");
		Assert.assertEquals(actualPortfolioWebsite, portfolioWebsite);
		String actualSalaryrequirements = driver.findElement(By.xpath("//div[@id='salaryInput']/input"))
				.getAttribute("value");
		Assert.assertEquals(actualSalaryrequirements, salaryrequirements);
		String actualWhenCanYouStart = driver.findElement(By.xpath("//div[@id='whenStartInput']/input"))
				.getAttribute("value");
		Assert.assertEquals(actualWhenCanYouStart, whenCanYouStart);
